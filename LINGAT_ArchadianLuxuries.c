...
// This function acts as Archadian Luxuries. Please see the main file for documentation.

void ArchadianLuxuries (int* pDay, int *pWallet, int* pDebt, int* pPhoenixDown, int* pElixirEssence, int* pPlatinumIngot, int* pGoldenMateria, int* pScarletite, int* pAdamantite, int* pDarkMatter, int* pTrapezohedron)
{
	int dAction, dBuy, dSell, dAmount, dSellBack;
	
	int dPricePD = getPrice(1200,500), dStockPD = getStock(30,19), dChancePD = getRandomizer(10,1), dSellPD;
	int dPriceEE = getPrice(2100,1500), dStockEE = getStock(25,15), dChanceEE = getRandomizer(10,1), dSellEE;
	
	int dPricePI = getPrice(6000,4500), dStockPI = getStock(45,20), dSellPI;
	
	int dPriceGM = getPrice(5500,3500), dStockGM = getStock(22,13), dChanceGM = getRandomizer(10,1), dSellGM;
	int dPriceSL = getPrice(12000, 8000), dStockSL = getStock(15,8), dChanceSL = getRandomizer(10,1), dSellSL;
	int dPriceAD = getPrice(30000, 15000), dStockAD = getStock(9,6), dChanceAD = getRandomizer(10,1), dSellAD;
	int dPriceDM = getPrice(70000, 40000), dStockDM = getStock(7,5), dChanceDM = getRandomizer(10,1), dSellDM;
	int dPriceTH = getPrice(90000,60000), dStockTH = getStock(3,1), dChanceTH = getRandomizer(10,1), dSellTH; 
